...
namespace big
{
	...
	void view::spawn_ped()
	{
		...
		ImGui::Checkbox("无敌", &g.world.spawn_ped.spawn_invincible);
		ImGui::Checkbox("隐身", &g.world.spawn_ped.spawn_invisible);
		ImGui::Checkbox("攻击者", &g.world.spawn_ped.spawn_as_attacker);
