...
namespace big
{
	void view::self()
	{
		...
		{
			ImGui::SliderFloat("PTFX 大小", &g.self.ptfx_effects.size, 0.1f, 2.f);
			if (ImGui::BeginCombo("项目", ptfx_named[g.self.ptfx_effects.select].friendly_name))
			{
			...
			if (ImGui::BeginCombo("效果", g.self.ptfx_effects.effect))
			{
