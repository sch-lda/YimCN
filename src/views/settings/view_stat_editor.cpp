...
namespace big
{
	...
	static void tab_item_stat()
	{
		if (ImGui::BeginTabItem("Stat"))
		{
			...
			case INT:
			{
				...
				components::input_text("值", stat_int_value, sizeof(stat_int_value), ImGuiInputTextFlags_None, [] { g.stat_editor.stat.int_value = stat_int_value; });
				components::button("应用", [] { helper::stat_set_int(stat_int_text, stat_int_value); }); ImGui::SameLine();
			...
			case BOOLEAN:
			{
				...
				components::button("应用", [] { helper::stat_set_bool(stat_bool_text, stat_bool_value); }); ImGui::SameLine();
			...
			case FLOAT:
			{
				...
				components::button("应用", [] { helper::stat_set_float(stat_float_text, stat_float_value); }); ImGui::SameLine();
			...
			case DATE:
			{
				...
				if (ImGui::IsItemHovered())
					ImGui::SetTooltip("年 月 日 时 分 秒 毫秒\n示例: 2022 1 17 21 34 55");
				components::button("应用", [] { helper::stat_set_date(stat_date_text, stat_date_value); }); ImGui::SameLine();
			...
			case STRING:
			{
				...
				components::button("应用", [] { helper::stat_set_string(stat_string_text, stat_string_value); }); ImGui::SameLine();
			...
			case USER_ID:
			{
				...
				components::button("应用", [] { helper::stat_set_user_id(stat_user_id_text, stat_user_id_value); }); ImGui::SameLine();
	...
	void view::stat_editor()
	{
		...
		components::sub_title("注意stat限制，谨慎使用，修改一些stat是有风险的.");
