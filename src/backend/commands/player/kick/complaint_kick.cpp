...
namespace big
{
	...
	complaint_kick g_complaint_kick("desync", "取消同步踢", "这可能需要等待十秒钟. 对战局主机无效", 0); // this is pretty much desync except we don't actually remove the player from CNetworkPlayerMgr
}